...
export default function CategoryInfoTable({ handleOpenModal, shop_id, refreshKey }) {
  ...
  const handleDeleteItem = async (id, item) => {
    try {
      ...
      toast.success('Category successfully deleted!', { position: 'top-center' });
            ...
            {rows
              ...
              .map((row, i) => (
                <TableRow key={row._id || i}>
                  ...
                  <TableCell align="center">{row?.category_info?.category_name}</TableCell>
                  <TableCell align="center">
                    <DeleteIcon
